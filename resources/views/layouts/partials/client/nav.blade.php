...
<div class="border-right" id="sidebar-wrapper">
  <div class="sidebar-heading d-flex"><a href="/edit-profile" style="color:#fff;text-decoration:none;"><img src="{{ avatar_picture_url(current_user()->avatar) }}"><span class="align-self-center">{{ current_user()->name }}</span></a></div>
...
<nav class="navbar navbar-expand-lg navbar-dark front-navbar">
  <a class="navbar-brand" href="#" style="color:#fff;text-decoration:none;"><img src="{{ asset('images/user-default.jpg') }}"><span>{{ current_user()->name }}</span></a>
