...
<div class="border-right" id="sidebar-wrapper">
  ...
  <div class="list-group list-group-flush">
    <a href="/home" class="list-group-item list-group-item-action {{ (request()->is('home')) ? 'active' : '' }}"><i class="fas fa-chart-pie"></i> Dashboard</a><!--active class on current page-->
    ...
    <a href="{{ route('quizzes.topics') }}" class="list-group-item list-group-item-action {{ (request()->is('quizzes/topics*')) ? 'active' : '' }}"><i class="fas fa-question-circle"></i> Quiz</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="/home"><i class="fas fa-chart-pie {{ (request()->is('home')) ? 'active' : '' }}"></i> Dashboard</a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{ route('quizzes.topics') }}"><i class="fas fa-question-circle {{ (request()->is('quizzes/topics*')) ? 'active' : '' }}"></i> Quiz</a>
      </li>
      <!-- <li class="nav-item">
